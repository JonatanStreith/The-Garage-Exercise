...
namespace The_Garage_Exercise.Managers
{
    internal class GarageManager
    {
        ...
        internal string ListParkedVehicles()
        {
            ...
            return $"Listed {results.Count} '{input}'.";
        }

        internal FilterData MultiFilterVehicle()
        {
    ...
    "\n\nPlease type in what vehicle(s) you are looking for. ";
        ...
        internal string ParkVehicle()
        {
            ...
            return $"Parked a {vehicle.Color} {vehicle.GetType().ToString()}.";
        }

        internal string RetrieveVehicle()
        {
            string retrievePrompt = "\nPlease provide the license number of the vehicle you wish to retrieve: ";

            return Handler.RetrieveVehicle(Help.GetInput(retrievePrompt));
        }
