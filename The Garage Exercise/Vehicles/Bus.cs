...
namespace The_Garage_Exercise.Vehicles
{
    internal class Bus : Vehicle, IVehicle
    {
        ...
        public Bus(string license, string owner, Color color, int wheels, Mobility mobility, int cylinderVolume, FuelType fuelType, int numberOfSeats, int length) : base(license, owner, color, wheels, mobility)
        {
        ...
        public static Bus RegisterVehicle(string[] ownership, string[] generalInfo, string[] typeInfo)
        {
