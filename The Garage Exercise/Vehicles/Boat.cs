...
namespace The_Garage_Exercise.Vehicles
{
    internal class Boat : Vehicle, IVehicle
    {
        ...
        public Boat(string license, string owner, Color color, int wheels, Mobility mobility, int cylinderVolume, FuelType fuelType, int length) : base(license, owner, color, wheels, mobility)
        {
